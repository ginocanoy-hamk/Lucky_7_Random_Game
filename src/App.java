...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        while (money > 0) {
            ...
            if (enteredNumber == 1) {
                System.out.println("You won! You've guessed one (7)! Total earnings, 3 euro");
                money = money + 3;
            } else if (enteredNumber == 2) {
                System.out.println("You won! You've guessed two (7s)! Total earnings, 5 euro");
                money = money + 5;
            } else if (enteredNumber == 3) {
                System.out.println("You won! You've guessed three (7s)! Total earnings, 10 euro");
                money = money + 10;
            } else {
                System.out.println("Sorry, you lost the game!");
            }

            System.out.println("Your total earnings: " + money + " euro");
        }
